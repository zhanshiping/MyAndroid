    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_paste:
          ...
          case R.id.menu_search:
                ...
                //显式intent调用NoteSearch类
                //ComponentName componentName = new ComponentName(NotesList.this, NoteSearch.class);
                // Intent intent = new Intent();
                //intent.setComponent(componentName);
                //Intent intent = new Intent(NotesList.this, com.example.android.notepad.NoteSearch.class);
                //startActivity(intent);
                //startActivity(new Intent(Intent.ACTION_INSERT, getIntent().getData()));这个是可以的
                //Intent intent = new Intent();
                //intent.setClass(NotesList.this,NoteSearch.class);
                // NotesList.this.startActivity(intent);
                //错误不在这，想要继承ListActivity，布局文件中必须有一个ListView，id必须是"@id/android:list"！！！
